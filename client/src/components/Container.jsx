  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Flex justifyContent={"center"} alignItems={"center"} gap={15} h={'full'} w={'full'}>
          <Flex
            py={30}
            px={10}
          ...
          <Flex
            ...
            boxShadow={"0px 4px 4px 0px rgba(28, 28, 28, 0.25);"}
          >
          <Text fontSize={'3xl'} fontWeight={600}>Account Receivable</Text>
          <Image src="/receive.svg" alt="Receive payment" />

          <Text fontSize={'lg'} textAlign={'center'} fontWeight={400}>Horem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis.</Text>
          </Flex>
          <Flex
            py={30}
            px={10}
            ...
            boxShadow={"0px 4px 4px 0px rgba(28, 28, 28, 0.25);"}
          >
          <Text fontSize={'3xl'} fontWeight={600}>Expenses</Text>
